...
volatile uint8_t I2C_SLAVE_ADDR[I2C_N_SLAVES]={0x40,0x60,0x42};
...
void i2c_reg_write_8bit(uint8_t col, uint8_t index, uint8_t data)
{
	i2c_reg[col][index] = data;
}

void i2c_reg_write_16bit(uint8_t col, uint8_t index, uint16_t data)
{
	uint8_t MSB = (data & 0xFF00) >> 8; 
	uint8_t LSB = (uint8_t)(data & 0x00FF); 
	i2c_reg[col][index] = MSB;
	i2c_reg[col][index+1] = LSB;
}

uint16_t i2c_reg_read_16bit(uint8_t col, uint8_t index)
{
	uint16_t temp = 0;
	uint8_t MSB = i2c_reg[col][index];
	uint8_t LSB = i2c_reg[col][index + 1];
...
uint8_t i2c_reg_read_8bit(uint8_t col, uint8_t index)
{
	return i2c_reg[col][index];
}
