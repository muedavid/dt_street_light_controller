...
#define N_LEDS 16 //maximal LED count, which are accessed by the addressable led bus
...
#define I2C_N_SLAVES 3 //maximal Count of i2c Slaves, which should be emulated, one is the motor, led and the SOC
